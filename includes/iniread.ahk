...
IniRead, CustomWaitTime,    %ININame%, %AppName%, CustomWaitTime
...
IniRead, FlagMessage,       %ININame%, %AppName%, FlagMessage
...
IniRead, RmndAndMoveFoldr,  %ININame%, %AppName%, RmndAndMoveFoldr
IniRead, RmndAndMove1Day,   %ININame%, %AppName%, RmndAndMove1Day
IniRead, RmndAndMove2Days,  %ININame%, %AppName%, RmndAndMove2Days
IniRead, RmndAndMove3Days,  %ININame%, %AppName%, RmndAndMove3Days
IniRead, RmndAndMove4Days,  %ININame%, %AppName%, RmndAndMove4Days
IniRead, RmndAndMove5Days,  %ININame%, %AppName%, RmndAndMove5Days
